/**
 * Country codes with flags and phone number formats
 * Used for phone number input in forms
 */
...
export const COUNTRIES = [
  ...
  { name: 'Republic of the Congo', code: 'CD', dialCode: '+243', flag: '🇨🇩' },
...
/**
 * Get country object by dial code
 */
...
/**
 * Default country (Uganda - based on AXSEL location)
 */
export const DEFAULT_COUNTRY = COUNTRIES.find(country => country.code === 'UG') || COUNTRIES[0];
